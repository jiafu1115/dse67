    ...
    public <P> void serialize(Message<P> message, DataOutputPlus out) throws IOException {
        ...
        if (message.isRequest()) {
            ...
            if (response.isFailure()) {
                ...
                ((VerbSerializer)serializer).requestSerializer.serialize(response.payload(), out);
            }
        }
    }
    ...
    public <P> Message<P> deserialize(TrackedDataInputPlus in, int size, InetAddress from) throws IOException {
        ...
        if ((flags & 1) == 0) {
            ...
            if ((flags & 16) != 0) {
                ...
                data = new Message.Data(null, -1L, createdAtMillis, timeoutMillis, parameters, tracingInfo);
